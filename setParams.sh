...
#Example Use "bash setParams.sh 5" that sets the Radius Below equal to 5 on parameters.hpp

rm ./headers/parameters.hpp

echo "#ifndef PARAMETERS_HPP
...
#define TILES 16
#define R ${1} //Radius of the patch window
